...
public class MealPlannerAndMealConverter {
    public static MealPlanner getMealPlannerFromMealAndDate(Meal meal, String date, int dayOfWeek) {
    ...
    public static Meal getMealFromMealPlanner(MealPlanner  mealPlanner){
        Meal meal = new Meal();
